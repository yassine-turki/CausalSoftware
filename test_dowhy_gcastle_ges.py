...
g=run_ges(dataset)
g=delete_path(g,labels,["relationship","age"])
g=delete_path(g,labels,["hours_per_week","age"])
draw_graph(g, labels, filename = "ref")

# Compute ATE, ATC, ATT
dict_of_estimates = compute_estimates_dowhy(g,dowhy_data, treatment = "workclass", outcome = "occupation", method_name = "backdoor.propensity_score_stratification")
print(dict_of_estimates)
#Compute Direct Effect
direct_effect = compute_direct_effect_dowhy(g, dowhy_data, treatment = "workclass", outcome = "occupation", estimator = "propensity_score_weighting_estimator")
print("Direct effect from treatment to outcome =", direct_effect)
#Compute Indirect Effect
indirect_effect = compute_indirect_effect_dowhy(g, dowhy_data, treatment = "workclass", outcome = "occupation",estimator = "propensity_score_stratification_estimator")
