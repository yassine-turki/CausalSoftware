# -*- coding: utf-8 -*-
"""Test_dowhy_CausalLearn_PC.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1h98bqozJvhLjSbQRPyeIvUGAJ2tdk6nU

Run this cell to install libraries, then restart the kernel
"""
...
def run_pc(data,labels,alpha=0.05, indep_test='fisherz', stable=True, uc_rule=0, uc_priority=2, mvpc=False, correction_name='MV_Crtn_Fisher_Z', background_knowledge=None, verbose=False, show_progress=True):
...
# Compute ATE, ATC, ATT
dict_of_estimates = compute_estimates_dowhy(g,dowhy_data, treatment = "workclass", outcome = "marital_status", method_name = "backdoor.generalized_linear_model")
print(dict_of_estimates)
#Compute Direct Effect
direct_effect = compute_direct_effect_dowhy(g, dowhy_data, treatment = "workclass", outcome = "marital_status", estimator = "generalized_linear_model_estimator")
print("Direct effect from treatment to outcome =", direct_effect)
#Compute Indirect Effect
indirect_effect = compute_indirect_effect_dowhy(g, dowhy_data, treatment = "workclass", outcome = "marital_status", estimator = "generalized_linear_model_estimator")
